...
int findNum(int arr[], int arrLength, int targetNum)
{
...
{
	int indexTargetNum = findNum(arr, arrLength, targetNum);

	cout << "Number you are looking for is " << targetNum << "\n";

	if (indexTargetNum != -1)
	{
		cout << "The number found at position " << indexTargetNum << "\n";
		cout << "The number found its order in " << indexTargetNum + 1 << "\n";
	}
	else
